...
POW_FUNC = lambda data: pack.IntType(256).unpack(__import__('../../../litecoin_scrypt/build/lib.linux-x86_64-2.7/ltc_scrypt').getPoWHash(data))
BLOCK_PERIOD = 150 # s
SYMBOL = 'CY'
...
BLOCK_EXPLORER_URL_PREFIX = 'https://explorer.cyberyen.org/block/'
ADDRESS_EXPLORER_URL_PREFIX = 'https://explorer.cyberyen.org/address/'
TX_EXPLORER_URL_PREFIX = 'https://explorer.cyberyen.org/tx/'
